...
**mlr**: a standardized interface to machine learning in **R**.
...
# or enable supercomputing clusters with the future package 
drake_hpc_template_file("torque_batchtools.tmpl") 
library(future.batchtools)
future::plan(batchtools_torque, 
             template = "torque_batchtools.tmpl", workers = 8000)
